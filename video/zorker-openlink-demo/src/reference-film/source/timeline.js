...
'use client';
import { projectMessageRevisions } from "../../source-snapshot/lib/agent-runtime/message-revisions.js";
import { orderAgentEvents } from "../../source-snapshot/lib/agent-runtime/stream-integrity.js";
import { agentErrorTitle, groupAgentErrorRecords } from "../../source-snapshot/lib/agent-runtime/error-groups.js";
import { useT } from "../../source-snapshot/lib/i18n/client.js";
import { Conversation, ConversationContent, } from "../../adapters/conversation";
import { Message, MessageContent, MessageResponse } from "../../source-snapshot/components/ai-elements/message.js";
import { Reasoning, ReasoningContent, ReasoningTrigger } from "../../source-snapshot/components/ai-elements/reasoning.js";
import { Task, TaskContent, TaskTrigger } from "../../source-snapshot/components/ai-elements/task.js";
import { ChatCodePreview } from "../../source-snapshot/components/chat-code-preview.js";
import { ThinkingOrb } from "../../adapters/orb";
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuSub, DropdownMenuSubContent, DropdownMenuSubTrigger, DropdownMenuTrigger, } from "../../source-snapshot/components/ui/dropdown-menu.js";
...
function WorkFlowGroup({ activeFlow, children, round, }) {
    const open = useContext(FilmState).workflowOpen ?? (round.state === "working");
    const t = useT();
    ...
    const checkpointText = checkpoint ? [
        ...
        checkpoint.metrics?.model ?? 'GPT-6 Luna',
    ].join('\n') : '';
