...
export function ThinkingOrb({ state = 'working', size = 64, theme = 'auto', speed = 1, paused = false, style, 'aria-label': ariaLabel, ...rest }) {
    ...
    return (_jsx("canvas", { ref: ref, role: "img", "aria-label": ariaLabel ?? LABELS[state], style: { width: size, height: size, display: 'block', ...style }, ...rest }));
}
